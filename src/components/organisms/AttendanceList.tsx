...
export function AttendanceList({
  ...
  const columns: Column<AttendanceRecord>[] = [
    ...
    { id: 'name', header: '이름', accessor: (r) => r.name, width: 74, align: 'center' },
    { id: 'studentId', header: '학번', accessor: (r) => r.studentId, width: 74, align: 'center' },
    { id: 'part', header: '파트', accessor: (r) => r.part, width: 74, align: 'center' },
    {
      id: 'present',
      header: '출석상태',
      width: 74,
    ...
    },
    {
      ...
      cell: (r) => (
        <button
          ...
          aria-label="비고"
          className={`truncate text-black ${r.remark ? 'underline' : ''}`}
        >
          {r.remark}
        </button>
      ),
