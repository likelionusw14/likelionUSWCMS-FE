...
const MOCK_PROJECTS: ApiProjectResponse[] = [
  {
    ...
    endedMonth: '2026-03',
    participants: [
      { userId: 21017023, name: '김대머', role: '팀장' },
      { userId: 22017055, name: '이대머', role: '팀원' },
      { userId: 22017056, name: '박대머', role: '팀원' },
      { userId: 22017057, name: '최대머', role: '팀원' },
    ],
    version: 0,
    createdAt: '2026-03-02T10:00:00Z',
  ...
  },
  {
    ...
    endedMonth: '2026-02',
    participants: [
      { userId: 21017024, name: '김형진', role: '팀원' },
      { userId: 22017058, name: '신준호', role: '팀장' },
    ],
    version: 0,
    createdAt: '2026-02-20T09:00:00Z',
  ...
  },
  {
    ...
    endedMonth: '2025-08',
    participants: [{ userId: 21017025, name: '이수원', role: '팀장' }],
    version: 0,
    createdAt: '2025-08-15T12:00:00Z',
